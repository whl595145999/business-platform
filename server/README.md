## 供应链业务平台（whl-scm-platform）

| 项 | 说明 |
|---|---|
| 作者 | whl |
| 产品名 | 供应链业务平台 |
| Maven | `com.whl:whl-scm-platform:5.6.1` |
| 数据库 | `business_platform`（单库，领域表前缀见 `docs/DATABASE.md`） |
| 架构文档 | [docs/README.md](docs/README.md) |

> 本项目基于 [RuoYi-Vue-Plus 5.6.1](https://gitee.com/dromara/RuoYi-Vue-Plus) 脚手架演进，保留其开源协议与致谢。  
> 当前阶段仅完成品牌化与架构设计，业务模块（OMS / WMS 等）将按路线图逐步落地。
