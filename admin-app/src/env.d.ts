...
interface ImportMetaEnv {
  ...
  /** 认证模式，'platform' | 'single' | 'double' */
  readonly VITE_AUTH_MODE: 'platform' | 'single' | 'double'
  /** 业务平台客户端 ID（对应 sys_client 表） */
  readonly VITE_CLIENT_ID: string
  /** 是否开启接口加密（与 admin-web 一致） */
  readonly VITE_APP_ENCRYPT: 'true' | 'false'
  /** RSA 公钥 */
