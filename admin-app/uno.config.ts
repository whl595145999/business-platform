...
import { MENU_ICON_SAFELIST } from './src/constants/menu-icons'
...
export default defineConfig({
  ...
  shortcuts: [
    {
      ...
      'bp-page': 'min-h-screen bg-[var(--bp-bg-page)]',
      'bp-card': 'bg-[var(--bp-bg-card)] rounded-[var(--bp-radius-md)] shadow-[var(--bp-shadow-card)]',
      'bp-text-secondary': 'text-[var(--bp-text-secondary)]',
      'bp-text-tertiary': 'text-[var(--bp-text-tertiary)]',
    },
  ],
  ...
  theme: {
    colors: {
      ...
      primary: 'var(--bp-color-primary,#1677ff)',
    },
    fontSize: {
